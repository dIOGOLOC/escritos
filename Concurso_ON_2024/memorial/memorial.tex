...
\begin{summarybox}[frametitle=\faBookmark{}\quad Resumo de atividades científica]
  \begin{fa-ul}
      \faBuilding & 17 Congresso Internacional da Sociedade Brasileira de Geofísica e EXPOGEf \\
      \faBook & New horizons in Brazilian Seismology: expanding seismic monitoring to offshore Southeast Brazil. \\
      \faChild & COELHO, D. L. O.; FONTES, S. L.; KLEIN, A. H. F.; DIAS, F. L.; MAURICIO, I. C. B. S.; MACHADO, A. A.; PRADO, M. F. V.; LIMA, A. P. Y.; SILVA, A. A. C.; THEODORO, C.E.; ROSALBA, J. F.; SOBREIRA, J. F. F.; MAHIQUES, M. M.; BUENO, G. V.\\
      \faCertificate & \href{https://sbgf.org.br/mysbgf/eventos/expanded_abstracts/17th_CISBGf/170620210624192518Expanded_abstract_SBGf_2021.pdf}{Apresentação}  \\
      \faCalendar & 2021 \\

      \faBuilding & Artigo em preparação: apresentação dos resultados da análise do banco de dados coletado pelos sismômetros de fundo oceânico, onde o principal objetivo é
destacar a sismicidade local na rede de OBSs \\
      \faBook & Seismicity, performance and noise recorded by ocean bottom seismometers monitoring of the Southeast Offshore of Brazil. \\
      \faChild & COELHO, D. L. O.; FONTES, S. L.; KLEIN, A. H. F.; DIAS, F. L.; MAURICIO, I. C. B. S.; MACHADO, A. A.; PRADO, M. F. V.; LIMA, A. P. Y.; SILVA, A. A. C.; THEODORO, C.E.; ROSALBA, J. F.; SOBREIRA, J. F. F.; MAHIQUES, M. M.; BUENO, G. V.\\
      \faCalendar & 2024 \\
  \end{fa-ul}
\end{summarybox}
...
\begin{summarybox}[frametitle=\faBookmark{}\quad Resumo de atividades científica]
  \begin{fa-ul}
      \faBuilding & Artigo em preparação: apresentação de um programa que é dedicado a fornecer uma estrutura em Python® (linguagem de programação) para análise de dados sismológicos de sismômetros de fundo oceânico (OBSs). \\
      \faBook & Zooxantela: An Ocean-Bottom Seismometer Toolkit. \\
      \faChild & COELHO, D. L. O.; KLEIN, A. H. F.; FONTES, S. L.\\
      \faCalendar & 2024 \\
  \end{fa-ul}
\end{summarybox}
